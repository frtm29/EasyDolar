...
def realizar_prediccion_sarima(data, start, end, order=(1, 1, 1), seasonal_order=(1, 1, 1, 5), lags=6): #alfinal son 5 dias de lags, pero pongo 6 por como esta construido el código,
...
def evaluar_y_graficar_predicciones(test_data):
